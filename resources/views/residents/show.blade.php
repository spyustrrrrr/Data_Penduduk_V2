...
@section('content')
<div class="max-w-4xl mx-auto bg-white rounded-2xl shadow-2xl p-10 ring-2 ring-sky-800">
    ...
    <div>
        <h4 class="text-lg font-semibold text-gray-900 mb-1 pb-3 border-b-2 border-blue-600">
            <i class="fas fa-id-card text-blue-600 mr-2"></i>Data Kartu Keluarga
        </h4>
        <div class="grid grid-cols-2 gap-x-6 gap-y-4 mb-8">
                <div>
                    <dt class="text-sm font-semibold text-gray-600">RT</dt>
                    <dd class="text-lg text-gray-900">{{ $resident->kk->rt }}</dd>
                </div>
                <div>
                    <dt class="text-sm font-semibold text-gray-600">RW</dt>
                    <dd class="text-lg text-gray-900">{{ $resident->kk->rw }}</dd>
                </div>
                <div>
                ...
                <div>
                    <dt class="text-sm font-semibold text-gray-600">Kecamatan</dt>
                    <dd class="text-lg text-gray-900">{{ $resident->kk->kecamatan }}</dd>
                </div>
                <div>
                    <dt class="text-sm font-semibold text-gray-600">Kelurahan/Desa</dt>
                    <dd class="text-lg text-gray-900">{{ $resident->kk->kelurahan }}</dd>
                </div>
        </div>
    </div>
    <div>
        ...
        <div class="grid grid-cols-2 gap-x-6 gap-y-4">
            ...
            <div class="row-span-3 hover:row-span-4  group">
                <dt class="absolute text-sm font-semibold text-gray-600 uppercase">foto ktp</dt>
                <dd>
                    <img src="{{ asset('storage/' . $resident->foto_ktp) }}"
                        alt="Foto KTP {{ $resident->nama }}"
                        class="w-auto h-[200px] group-hover:h-[300px]  transition-all rounded-lg shadow-md hover:scale-105 object-cover grow">
                </dd>
            @else
            <div class="row-span-3  group">
                <div class="text-center h-[200px] py-8 text-gray-400 bg-sky-50 rounded-2xl border-2 border-dashed border-gray-400 shadow-sm">
